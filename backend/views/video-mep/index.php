...
$modelLabel = new \backend\models\VideoMep();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
            <!-- row start search-->
          	<div class="row">
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'video-mep-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('video-mep/index')]); ?>     
                  ...
                  <div class="form-group" style="margin: 5px;">
                      ...
                      <input type="text" class="form-control" id="query[account_name]" name="query[account_name]"  value="<?=isset($query["account_name"]) ? $query["account_name"] : "" ?>">
                      <label><?=$modelLabel->getAttributeLabel('account_id')?>:</label>
                      <input type="text" class="form-control" id="query[account_id]" name="query[account_id]"  value="<?=isset($query["account_id"]) ? $query["account_id"] : "" ?>">
                  </div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "video-mep-form", "class"=>"form-horizontal", "action"=>Url::toRoute("video-mep/save")]); ?>                      
          ...
          <div id="ranking_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="ranking" name="VideoMep[ranking]" placeholder="" />
              </div>
          ...
          <div id="account_name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="account_name" name="VideoMep[account_name]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="account_id_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="account_id" name="VideoMep[account_id]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="platform_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="platform" name="VideoMep[platform]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="gender_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="gender" name="VideoMep[gender]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="integrated_marketing_gain_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="integrated_marketing_gain" name="VideoMep[integrated_marketing_gain]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="spread_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="spread_index" name="VideoMep[spread_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="interactive_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="interactive_index" name="VideoMep[interactive_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="activity_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="activity_index" name="VideoMep[activity_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="growth_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="growth_index" name="VideoMep[growth_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="health_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="health_index" name="VideoMep[health_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="business_fitness_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="business_fitness_index" name="VideoMep[business_fitness_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="wechat_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="wechat" name="VideoMep[wechat]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="weibo_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="weibo" name="VideoMep[weibo]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="mobile_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="mobile" name="VideoMep[mobile]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="telephone_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="telephone" name="VideoMep[telephone]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="contact_status_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="contact_status" name="VideoMep[contact_status]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="remark_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="remark" name="VideoMep[remark]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="create_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_date" name="VideoMep[create_date]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_time" name="VideoMep[update_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
...
function initModel(id, type, fun){
	...
	$.ajax({
		   type: "GET",
		   url: "<?=Url::toRoute('video-mep/view')?>",
		   data: {"id":id},
		   cache: false,
		   dataType:"json",
...
function deleteAction(id){
	...
	if(ids.length > 0){
		admin_tool.confirm('请确认是否删除', function(){
		    $.ajax({
				   type: "GET",
				   url: "<?=Url::toRoute('video-mep/delete')?>",
				   data: {"ids":ids},
				   cache: false,
				   dataType:"json",
				   error: function (xmlHttpRequest, textStatus, errorThrown) {
...
$('#video-mep-form').bind('submit', function(e) {
	e.preventDefault();
	var id = $("#id").val();
	var action = id == "" ? "<?=Url::toRoute('video-mep/create')?>" : "<?=Url::toRoute('video-mep/update')?>";
    $(this).ajaxSubmit({
    	type: "post",
    	dataType:"json",
    	url: action,
