...
$modelLabel = new \backend\models\VideoKs();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
            <!-- row start search-->
          	<div class="row">
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'video-ks-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('video-ks/index')]); ?>     
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "video-ks-form", "class"=>"form-horizontal", "action"=>Url::toRoute("video-ks/save")]); ?>                      
          ...
          <div id="ranking_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="ranking" name="VideoKs[ranking]" placeholder="" />
              </div>
          ...
          <div id="account_name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="account_name" name="VideoKs[account_name]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="account_id_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="account_id" name="VideoKs[account_id]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="platform_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="platform" name="VideoKs[platform]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="gender_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="gender" name="VideoKs[gender]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="integrated_marketing_gain_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="integrated_marketing_gain" name="VideoKs[integrated_marketing_gain]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="spread_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="spread_index" name="VideoKs[spread_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="interactive_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="interactive_index" name="VideoKs[interactive_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="activity_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="activity_index" name="VideoKs[activity_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="growth_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="growth_index" name="VideoKs[growth_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="health_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="health_index" name="VideoKs[health_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="business_fitness_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="business_fitness_index" name="VideoKs[business_fitness_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="wechat_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="wechat" name="VideoKs[wechat]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="weibo_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="weibo" name="VideoKs[weibo]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="mobile_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="mobile" name="VideoKs[mobile]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="telephone_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="telephone" name="VideoKs[telephone]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="contact_status_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="contact_status" name="VideoKs[contact_status]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="remark_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="remark" name="VideoKs[remark]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="create_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_date" name="VideoKs[create_date]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_time" name="VideoKs[update_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
...
function deleteAction(id){
	...
	if(ids.length > 0){
		admin_tool.confirm('请确认是否删除', function(){
		    $.ajax({
				   type: "GET",
				   url: "<?=Url::toRoute('video-ks/delete')?>",
				   data: {"ids":ids},
				   cache: false,
				   dataType:"json",
				   error: function (xmlHttpRequest, textStatus, errorThrown) {
...
$('#video-ks-form').bind('submit', function(e) {
	e.preventDefault();
	var id = $("#id").val();
	var action = id == "" ? "<?=Url::toRoute('video-ks/create')?>" : "<?=Url::toRoute('video-ks/update')?>";
    $(this).ajaxSubmit({
    	type: "post",
    	dataType:"json",
    	url: action,
