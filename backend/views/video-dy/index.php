...
$modelLabel = new \backend\models\VideoDy();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
            <!-- row start search-->
          	<div class="row">
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'video-dy-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('video-dy/index')]); ?>     
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "video-dy-form", "class"=>"form-horizontal", "action"=>Url::toRoute("video-dy/save")]); ?>                      
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="ranking" name="VideoDy[ranking]" placeholder="" />-->
<!--              </div>-->
...
<!---->
          <div id="account_name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="account_name" name="VideoDy[account_name]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="account_id_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="account_id" name="VideoDy[account_id]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="platform" name="VideoDy[platform]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="gender" name="VideoDy[gender]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="integrated_marketing_gain" name="VideoDy[integrated_marketing_gain]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="spread_index" name="VideoDy[spread_index]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="interactive_index" name="VideoDy[interactive_index]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="activity_index" name="VideoDy[activity_index]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="growth_index" name="VideoDy[growth_index]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="health_index" name="VideoDy[health_index]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="business_fitness_index" name="VideoDy[business_fitness_index]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
          ...
          <div id="wechat_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="wechat" name="VideoDy[wechat]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="weibo_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="weibo" name="VideoDy[weibo]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="mobile_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="mobile" name="VideoDy[mobile]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="telephone_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="telephone" name="VideoDy[telephone]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="contact_status_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="contact_status" name="VideoDy[contact_status]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="remark_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="remark" name="VideoDy[remark]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="create_date" name="VideoDy[create_date]" placeholder="必填" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="update_time" name="VideoDy[update_time]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
...
function deleteAction(id){
	...
	if(ids.length > 0){
		admin_tool.confirm('请确认是否删除', function(){
		    $.ajax({
				   type: "GET",
				   url: "<?=Url::toRoute('video-dy/delete')?>",
				   data: {"ids":ids},
				   cache: false,
				   dataType:"json",
				   error: function (xmlHttpRequest, textStatus, errorThrown) {
...
$('#video-dy-form').bind('submit', function(e) {
	e.preventDefault();
	var id = $("#id").val();
	var action = id == "" ? "<?=Url::toRoute('video-dy/create')?>" : "<?=Url::toRoute('video-dy/update')?>";
    $(this).ajaxSubmit({
    	type: "post",
    	dataType:"json",
    	url: action,
