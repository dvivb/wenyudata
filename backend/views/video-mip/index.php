...
$modelLabel = new \backend\models\VideoMip();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
            <!-- row start search-->
          	<div class="row">
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'video-mip-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('video-mip/index')]); ?>     
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "video-mip-form", "class"=>"form-horizontal", "action"=>Url::toRoute("video-mip/save")]); ?>                      
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="ranking" name="VideoMip[ranking]" placeholder="" />-->
<!--              </div>-->
...
<!--          </div>-->
          ...
          <div id="account_name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="account_name" name="VideoMip[account_name]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="account_id_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="account_id" name="VideoMip[account_id]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="platform" name="VideoMip[platform]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="gender" name="VideoMip[gender]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="integrated_marketing_gain" name="VideoMip[integrated_marketing_gain]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="spread_index" name="VideoMip[spread_index]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="interactive_index" name="VideoMip[interactive_index]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="activity_index" name="VideoMip[activity_index]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="growth_index" name="VideoMip[growth_index]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="health_index" name="VideoMip[health_index]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="business_fitness_index" name="VideoMip[business_fitness_index]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
          ...
          <div id="wechat_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="wechat" name="VideoMip[wechat]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="weibo_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="weibo" name="VideoMip[weibo]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="mobile_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="mobile" name="VideoMip[mobile]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="telephone_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="telephone" name="VideoMip[telephone]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="contact_status_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="contact_status" name="VideoMip[contact_status]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="remark_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="remark" name="VideoMip[remark]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="create_date" name="VideoMip[create_date]" placeholder="必填" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
<!---->
...
<!--              <div class="col-sm-10">-->
<!--                  <input type="text" class="form-control" id="update_time" name="VideoMip[update_time]" placeholder="" />-->
<!--              </div>-->
<!--              <div class="clearfix"></div>-->
<!--          </div>-->
...
function initModel(id, type, fun){
	...
	$.ajax({
		   type: "GET",
		   url: "<?=Url::toRoute('video-mip/view')?>",
		   data: {"id":id},
		   cache: false,
		   dataType:"json",
...
function deleteAction(id){
	...
	if(ids.length > 0){
		admin_tool.confirm('请确认是否删除', function(){
		    $.ajax({
				   type: "GET",
				   url: "<?=Url::toRoute('video-mip/delete')?>",
				   data: {"ids":ids},
				   cache: false,
				   dataType:"json",
				   error: function (xmlHttpRequest, textStatus, errorThrown) {
...
$('#video-mip-form').bind('submit', function(e) {
	e.preventDefault();
	var id = $("#id").val();
	var action = id == "" ? "<?=Url::toRoute('video-mip/create')?>" : "<?=Url::toRoute('video-mip/update')?>";
    $(this).ajaxSubmit({
    	type: "post",
    	dataType:"json",
    	url: action,
