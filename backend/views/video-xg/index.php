...
$modelLabel = new \backend\models\VideoXg();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
            <!-- row start search-->
          	<div class="row">
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'video-xg-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('video-xg/index')]); ?>     
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "video-xg-form", "class"=>"form-horizontal", "action"=>Url::toRoute("video-xg/save")]); ?>                      
          ...
          <div id="ranking_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="ranking" name="VideoXg[ranking]" placeholder="" />
              </div>
          ...
          <div id="account_name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="account_name" name="VideoXg[account_name]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="account_id_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="account_id" name="VideoXg[account_id]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="platform_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="platform" name="VideoXg[platform]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="gender_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="gender" name="VideoXg[gender]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="integrated_marketing_gain_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="integrated_marketing_gain" name="VideoXg[integrated_marketing_gain]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="spread_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="spread_index" name="VideoXg[spread_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="interactive_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="interactive_index" name="VideoXg[interactive_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="activity_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="activity_index" name="VideoXg[activity_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="growth_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="growth_index" name="VideoXg[growth_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="health_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="health_index" name="VideoXg[health_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="business_fitness_index_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="business_fitness_index" name="VideoXg[business_fitness_index]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="wechat_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="wechat" name="VideoXg[wechat]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="weibo_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="weibo" name="VideoXg[weibo]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="mobile_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="mobile" name="VideoXg[mobile]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="telephone_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="telephone" name="VideoXg[telephone]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="contact_status_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="contact_status" name="VideoXg[contact_status]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="remark_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="remark" name="VideoXg[remark]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="create_date_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_date" name="VideoXg[create_date]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_time" name="VideoXg[update_time]" placeholder="" />
              </div>
              <div class="clearfix"></div>
          </div>
...
function deleteAction(id){
	...
	if(ids.length > 0){
		admin_tool.confirm('请确认是否删除', function(){
		    $.ajax({
				   type: "GET",
				   url: "<?=Url::toRoute('video-xg/delete')?>",
				   data: {"ids":ids},
				   cache: false,
				   dataType:"json",
				   error: function (xmlHttpRequest, textStatus, errorThrown) {
...
$('#video-xg-form').bind('submit', function(e) {
	e.preventDefault();
	var id = $("#id").val();
	var action = id == "" ? "<?=Url::toRoute('video-xg/create')?>" : "<?=Url::toRoute('video-xg/update')?>";
    $(this).ajaxSubmit({
    	type: "post",
    	dataType:"json",
    	url: action,
